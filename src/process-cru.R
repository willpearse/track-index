...
.clean.cru <- function(file, var){
    nc.raw <- read.nc(open.nc())
    output <- array(dim=c(dim(nc.raw[[var]])[1:2], length(1901:2016)))
...
# Do work
saveRDS(
    .clean.cru(paste0(cru.dir,"cru_ts4.03.1901.2018.cld.dat.nc.gz")),
    paste0(output.dir,"cru-cld.RDS")
)
saveRDS(
    .clean.cru(paste0(cru.dir,"cru_ts4.03.1901.2018.dtr.dat.nc.gz")),
    paste0(output.dir,"cru-dtr.RDS")
)
saveRDS(
    .clean.cru(paste0(cru.dir,"cru_ts4.03.1901.2018.frs.dat.nc.gz")),
    paste0(output.dir,"cru-frs.RDS")
)
saveRDS(
    .clean.cru(paste0(cru.dir,"cru_ts4.03.1901.2018.pet.dat.nc.gz")),
    paste0(output.dir,"cru-pet.RDS")
)
saveRDS(
    .clean.cru(paste0(cru.dir,"cru_ts4.03.1901.2018.pre.dat.nc.gz")),
    paste0(output.dir,"cru-pre.RDS")
)
saveRDS(
    .clean.cru(paste0(cru.dir,"cru_ts4.03.1901.2018.tmn.dat.nc.gz")),
...
saveRDS(
    .clean.cru(paste0(cru.dir,"cru_ts4.03.1901.2018.tmp.dat.nc.gz")),
    paste0(output.dir,"cru-tmp.RDS")
)
saveRDS(
    .clean.cru(paste0(cru.dir,"cru_ts4.03.1901.2018.tmx.dat.nc.gz")),
    paste0(output.dir,"cru-tmx.RDS")
)
saveRDS(
    .clean.cru(paste0(cru.dir,"cru_ts4.03.1901.2018.vap.dat.nc.gz")),
    paste0(output.dir,"cru-vap.RDS")
)saveRDS(
    .clean.cru(paste0(cru.dir,"cru_ts4.03.1901.2018.wet.dat.nc.gz")),
